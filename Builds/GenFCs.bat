...
"C:\Documents and Settings\David\My Documents\Work\OpenSGToolbox\External\GnuWin32\bin\sed.exe" -f "C:\Documents and Settings\David\My Documents\Work\OpenSGToolbox\Builds\CleanUpFC.sed" "OSG%~n1Fields.h" > "OSG%~n1Fields.h.temp"
