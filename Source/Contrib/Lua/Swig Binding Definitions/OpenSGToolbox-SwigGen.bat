...
set INTERFACE_FILE_PATH=C:\Users\David\Documents\Work\OpenSG-2.X\Toolbox\OpenSGToolbox\Source\Contrib\Lua\Swig Binding Definitions\OSGToolbox.i

:Location of the output file to generate
set OUTPUT_FILE_PATH=C:\Users\David\Documents\Work\OpenSG-2.X\Toolbox\OpenSGToolbox\Source\Contrib\Lua\ToolboxBindings\src\Bindings\OSGToolbox_wrap.cpp
