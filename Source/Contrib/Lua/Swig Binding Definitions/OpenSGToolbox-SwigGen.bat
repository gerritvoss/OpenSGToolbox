...
set INTERFACE_FILE_PATH=C:\Documents and Settings\David\My Documents\Work\OpenSGToolbox\trunk\Lua\Swig Binding Definitions\OSGToolbox.i

:Location of the output file to generate
set OUTPUT_FILE_PATH=C:\Documents and Settings\David\My Documents\Work\OpenSGToolbox\trunk\Lua\ToolboxBindings\src\Bindings\OSGToolbox_wrap.cpp
