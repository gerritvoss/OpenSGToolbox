...
int main(int argc, char **argv)
{
    ...
    DialogPtr RootDialogChildB = TutorialDialog->addDialog("Background", 0.0, NullFC, true, rootDialog);
    ADialogChildA = TutorialDialog->addDialog("Blue", 0.0, NullFC, true, RootDialogChildA);
    ADialogChildB = TutorialDialog->addDialog("Red", 0.0, NullFC, true, RootDialogChildA);
    BDialogChildA = TutorialDialog->addDialog("Square", 0.0, NullFC, true, RootDialogChildB);
    BDialogChildB = TutorialDialog->addDialog("Sphere", 0.0, NullFC, true, RootDialogChildB);
    Restart1 = TutorialDialog->addDialog("Restart", 0.0, NullFC, true, ADialogChildA);
    End1 = TutorialDialog->addDialog("End", 0.0, NullFC, true, ADialogChildA);
    Restart2 = TutorialDialog->addDialog("Restart", 0.0, NullFC, true, ADialogChildB);
    End2 = TutorialDialog->addDialog("End", 0.0, NullFC, true, ADialogChildB);
    Restart3 = TutorialDialog->addDialog("Restart", 0.0, NullFC, true, BDialogChildA);
    End3 = TutorialDialog->addDialog("End", 0.0, NullFC, true, BDialogChildA);
    Restart4 = TutorialDialog->addDialog("Restart", 0.0, NullFC, true, BDialogChildB);
