...
#include <OpenSG/ParticleSystem/OSGUniformParticleAffector.h>
...
UniformParticleAffectorPtr ExampleUniformAffector;
...
int main(int argc, char **argv)
{
	...
	beginEditCP(ExampleUniformAffector);
		...
		ExampleUniformAffector->setBeacon(osg::Node::create()); // set to 'emulate' from (0,0,0)
	...
	beginEditCP(ExampleParticleSystem);
		...
		ExampleParticleSystem->getAffectors().push_back(ExampleUniformAffector);
