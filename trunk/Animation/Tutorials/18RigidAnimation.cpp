...
void setupAnimation(BonePtr TheLeftFemur,BonePtr TheRightFemur,BonePtr TheTorso, SkeletonPtr TheSkeleton);
...
int main(int argc, char **argv)
{
    ...
    TutorialWindowEventProducer->openWindow(Pnt2f(0,0),
                                        Vec2f(1280,1024),
                                        "OpenSG 18RigidAnimation Window");
...
//===========================================BONE==================================================================
	const int num = 3;
	BonePtr Torso, LeftFemur, RightFemur;
...
/*=================================================================================================*/
	...
	beginEditCP(TheNewSkeletonGeometry);
		...
		TheNewSkeletonGeometry->addBoneBlending(5,LeftFemur,1.0f,true);
		TheNewSkeletonGeometry->addBoneBlending(6,LeftFemur,1.0f,false);
		TheNewSkeletonGeometry->addBoneBlending(7,LeftFemur,1.0f,false);

		TheNewSkeletonGeometry->addBoneBlending(8,RightFemur,1.0f,true);
		TheNewSkeletonGeometry->addBoneBlending(9,RightFemur,1.0f,true);
		TheNewSkeletonGeometry->addBoneBlending(10,RightFemur,1.0f,false);
		TheNewSkeletonGeometry->addBoneBlending(11,RightFemur,1.0f,false);
   ...
   osg::beginEditCP(TheAnimationAdvancer);
	...
	//Setup the Animation
	setupAnimation(LeftFemur,RightFemur,Torso, ExampleSkeleton);
