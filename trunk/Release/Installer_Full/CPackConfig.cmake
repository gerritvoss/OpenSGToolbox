...
IF(UNIX)
    ...
    ELSE(APPLE)
        ...
        SET(INSTALLER_BASE_DIR "/home/users/dkabala/OpenSGToolbox/trunk/Release/Installer_Full")
        SET(TOOLBOX_INSTALL_DIR "/home/users/dkabala/OpenSGToolbox/trunk/Builds/Linux")
...
# Configure installer
SET(CPACK_PACKAGE_FILE_NAME "OpenSGToolbox-${CPACK_PACKAGE_VERSION}-${Project_WC_REVISION}-${OS_NAME}-${_CMAKE_MACHINE}")
