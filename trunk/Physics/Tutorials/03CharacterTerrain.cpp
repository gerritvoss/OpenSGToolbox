...
public:
   ...
   virtual void keyPressed(const KeyEvent& e)
   {
       ...
       case KeyEvent::KEY_UP:
           break;
       case KeyEvent::KEY_B:
           buildBox(Vec3f(10.0,10.0,10.0), Pnt3f((Real32)(rand()%100)-50.0,(Real32)(rand()%100)-50.0,30.0));
           break;
       case KeyEvent::KEY_C:
           buildCharacter(Vec3f(3.0,3.0,10.0), Pnt3f((Real32)(rand()%100)-50.0,(Real32)(rand()%100)-50.0,25.0));
           break;
       }
   }
...
PhysicsBodyPtr buildCharacter(Vec3f Dimensions, Pnt3f Position)
{
    ...
    PhysicsRayGeomPtr rayGeom = PhysicsRayGeom::create();
    beginEditCP(rayGeom, PhysicsRayGeom::BodyFieldMask | PhysicsRayGeom::SpaceFieldMask);
        rayGeom->setBody(boxBody);
        rayGeom->setSpace(hashSpace);
        rayGeom->setLenght(Dimensions.z());
    endEditCP(rayGeom, PhysicsRayGeom::BodyFieldMask | PhysicsRayGeom::SpaceFieldMask);

    //add attachments
    beginEditCP(boxNode, Node::AttachmentsFieldMask);
        boxNode->addAttachment(rayGeom);
    endEditCP(boxNode, Node::AttachmentsFieldMask);
    beginEditCP(boxTransNode, Node::AttachmentsFieldMask | Node::ChildrenFieldMask);
        boxTransNode->addAttachment(boxBody);
        boxTransNode->addChild(boxNode);
