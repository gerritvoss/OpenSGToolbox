MACRO(TOOLBOX_LIBRARY_DOCUMENTATION THE_DOXYGEN_EXECUTABLE
   ...
   IF(${ENABLE_USER_DOC} STREQUAL "ON")
      ...
      COMMAND DOC_REVISION_NUMBER=${DOCUMENTATION_REVISION} DOC_OUTPUT_DIR=${CMAKE_CURRENT_BINARY_DIR}/doc/user ${THE_DOXYGEN_EXECUTABLE} ${CMAKE_CURRENT_SOURCE_DIR}/../Documentation/Doxyfile.user
   ...
   ENDIF(${ENABLE_USER_DOC} STREQUAL "ON")
    ...
    IF(${ENABLE_DEV_DOC} STREQUAL "ON")
      ...
      COMMAND DOC_REVISION_NUMBER=${DOCUMENTATION_REVISION} DOC_OUTPUT_DIR=${CMAKE_CURRENT_BINARY_DIR}/doc/developer ${THE_DOXYGEN_EXECUTABLE} ${CMAKE_CURRENT_SOURCE_DIR}/../Documentation/Doxyfile.developer
...
ENDMACRO(TOOLBOX_LIBRARY_DOCUMENTATION THE_DOXYGEN_EXECUTABLE
      DOCUMENTATION_REVISION LIBRARY_NAME ENABLE_USER_DOC ENABLE_DEV_DOC
      DOC_HEADERS DOC_INLINES DOC_SOURCES)
