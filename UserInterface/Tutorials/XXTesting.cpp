...
public:
	...
	//class TestingButtonActionListener : public ActionListener
	//	{
	//	public:

	//	virtual void actionPerformed(const ActionEvent& e)
	//		{
	//			beginEditCP(Button::Ptr::dcast(e.getSource()), Button::TextFieldMask);
	//				Button::Ptr::dcast(e.getSource())->setText("Active");
	//			endEditCP(Button::Ptr::dcast(e.getSource()), Button::TextFieldMask);
...
class TestingButtonActionListener : public UpdateListener
{
public: TestingButtonActionListener(ButtonPtr 

  
    virtual void update(const UpdateEvent& e)
    {
		if(Button::Ptr::dcast(e.getSource())->getActive() = false)
		{
				beginEditCP(Button::Ptr::dcast(e.getSource()), Button::TextFieldMask);
					Button::Ptr::dcast(e.getSource())->setText("Inactive");
				endEditCP(Button::Ptr::dcast(e.getSource()), Button::TextFieldMask);
		}
				if(Button::Ptr::dcast(e.getSource())->getActive() = true)
		{
				beginEditCP(Button::Ptr::dcast(e.getSource()), Button::TextFieldMask);
					Button::Ptr::dcast(e.getSource())->setText("Active");
				endEditCP(Button::Ptr::dcast(e.getSource()), Button::TextFieldMask);
...
protected:
	...
	TestingButtonActionListener TheTestingButtonActionListener;
...
//    PanelPtr StatePanel = createStatePanel();
    ...
    beginEditCP(MainTabPanel, TabPanel::PreferredSizeFieldMask | TabPanel::TabsFieldMask | TabPanel::TabContentsFieldMask | TabPanel::ActiveTabFieldMask | TabPanel::TabAlignmentFieldMask | TabPanel::TabPlacementFieldMask  | TabPanel::ConstraintsFieldMask);
        ...
        MainTabPanel->addTab(StateTabPanelTab, testing.getPanel());
...
PanelPtr StatePanelCreator::createStatePanel(void) 
{
    ...
    ******************************************************/
	...
	TestingButtonActionListener TheTheTestingButtonActionListener(inactiveButton);
	
//	inactiveButton->addUpdateListener(&TheTestingButtonActionListener);
  ...
  /* 	Int32SpinnerModelPtr inactiveSpinnerModel(new Int32SpinnerModel());
    ...
    ******************************************************/
    ...
    beginEditCP(statePanel, Panel::ChildrenFieldMask | Panel::LayoutFieldMask  | Panel::PreferredSizeFieldMask);
        ...
        statePanel->getChildren().addValue(comboboxLabel);
        statePanel->getChildren().addValue(enabledLabel);
        statePanel->getChildren().addValue(disabledLabel);
		statePanel->getChildren().addValue(editableComboBox);
        statePanel->getChildren().addValue(noneditableComboBox);
