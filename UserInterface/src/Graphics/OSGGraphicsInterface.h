...
public:
	...
	virtual void drawLine(const Pnt2s& TopLeft, const Pnt2s& BottomRight, const Int16& Width, const Color4f& Color) const = 0;
	
	//virtual void drawPolygon(const MFPnt2s& Verticies, const Color4f& Color) const = 0;
	
	virtual void drawDisc(const Pnt2s& Center, const Int16& Width, const Int16& Height, const Int16& StartAngle, const Int16& EndAngle, const UInt16& SubDivisions, const Color4f& Color) const = 0;
	
	virtual void drawArc(const Pnt2s& Center, const Int16& Width, const Int16& Height, const Int16& StartAngle, const Int16& EndAngle, const Int16& Width, const UInt16& SubDivisions, const Color4f& Color) const = 0;
