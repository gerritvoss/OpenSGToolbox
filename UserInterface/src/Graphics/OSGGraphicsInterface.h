...
public:
	...
	virtual void drawArc(const Pnt2s& Center, const Int16& Width, const Int16& Height, const Int16& StartAngle, const Int16& EndAngle, const Int16& Width, const Color4f& Color) const = 0;
